...
class TestQuestions(BaseTest):
    ...
    def test_get_question_success(self):
        res = self.client().get('/api/v1/questions', headers=dict(token=self.login_user_0()))
        question_id = json.loads(res.data.decode())['questions'][0]['question_id']

        resp = self.client().get('/api/v1/questions/%s' % question_id, headers=dict(token=self.login_user_0()))
    ...
    def test_get_question_not_found(self):
        resp = self.client().get('/api/v1/questions/30', headers=dict(token=self.login_user_0()))
    ...
    def test_add_answer(self):
        question = Question('question add answer', 'question 10 body', auth_decode(self.login_user_0()))
        question.insert_question()

        resp = self.client().post('/api/v1/questions/' + question.question_id.__str__() + '/answers', data=json.dumps(
            dict(body='some body of answer 0')),
    ...
    def test_add_answer_duplicate(self):
        question = Question('question add answer another one', 'question 10 body', auth_decode(self.login_user_1()))
        question.insert_question()

        Answer('duplicate', auth_decode(self.login_user_1()), question.question_id).insert_answer()

        resp = self.client().post('/api/v1/questions/' + question.question_id.__str__() + '/answers', data=json.dumps(
            dict(body='duplicate')),
                                  content_type='application/json',
                                  headers=dict(token=self.login_user_1()))
    ...
    def test_delete_question(self):
        question = Question('question delete title', 'question 10 body', auth_decode(self.login_user_1()))
        question.insert_question()

        Answer('answer delete title', auth_decode(self.login_user_1()), question.question_id).insert_answer()
    ...
    def test_get_popular_question(self):
        user_id = auth_decode(self.login_user_1())
        question = Question('question 10 title', 'question 10 body', user_id)
        question.insert_question()

        Answer('answer 10 title', user_id, question.question_id).insert_answer()
        Answer('answer 101 title', user_id, question.question_id).insert_answer()
        Answer('answer 102 title', user_id, question.question_id).insert_answer()
        Answer('answer 103 title', user_id, question.question_id).insert_answer()
    ...
    def test_update_answer_body(self):
        question = Question('update answer', 'question 10 body', auth_decode(self.login_user_1()))
        question.insert_question()

        token = self.login_user_0()
    ...
    def test_update_answer_body_invalid_json(self):
        question = Question('update answer 1', 'question 10 body', auth_decode(self.login_user_1()))
        question.insert_question()
    ...
    def test_update_answer_body_invalid_token(self):
        question = Question('update answer 2', 'question 10 body', auth_decode(self.login_user_1()))
        question.insert_question()
    ...
    def test_update_answer_body_mark_as_preferred(self):
        ...
        answer = Answer('update answer preferred', user_id, question.question_id)
        answer.insert_answer()
